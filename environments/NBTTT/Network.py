...
class Network(Base):
    def __init__(self, lr, in_dim, h_dim, out_dim, device='cpu'):
        super().__init__()
        self.hidden1 = nn.Sequential(nn.Conv2d(in_dim, h_dim, kernel_size=(1, 3)),
                                     nn.BatchNorm2d(h_dim),
                                     nn.SiLU(True),
                                     nn.Conv2d(h_dim, h_dim * 2, kernel_size=(3, 1)),
                                     nn.BatchNorm2d(h_dim * 2),
                                     nn.SiLU(True),
                                     nn.Flatten())
        self.hidden2 = nn.Sequential(nn.Conv2d(in_dim, h_dim, kernel_size=(3, 1)),
                                     nn.BatchNorm2d(h_dim),
                                     nn.SiLU(True),
                                     nn.Conv2d(h_dim, h_dim * 2, kernel_size=(1, 3)),
                                     nn.BatchNorm2d(h_dim * 2),
                                     nn.SiLU(True),
                                     nn.Flatten())
        self.hidden3 = nn.Sequential(nn.Conv2d(in_dim, h_dim, kernel_size=(3, 3), padding=(2, 2)),
                                     nn.BatchNorm2d(h_dim),
                                     nn.SiLU(True),
                                     nn.Conv2d(h_dim, h_dim * 2, kernel_size=(3, 3)),
                                     nn.BatchNorm2d(h_dim * 2),
                                     nn.SiLU(True),
                                     nn.Conv2d(h_dim * 2, h_dim * 4, kernel_size=(3, 3)),
